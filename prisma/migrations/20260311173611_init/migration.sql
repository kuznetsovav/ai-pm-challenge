...
INSERT INTO "new_Progress" ("conceptCompleted", "dayNumber", "id", "interviewCompleted", "prototypeCompleted") SELECT "conceptCompleted", "dayNumber", "id", "interviewCompleted", "prototypeCompleted" FROM "Progress";
DROP TABLE "Progress";
